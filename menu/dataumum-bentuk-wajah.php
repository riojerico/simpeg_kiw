...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data Bentuk Wajah <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Bentuk Wajah</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/bntkWajah.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <label for="wajah" class="col-sm-3 control-label">Bentuk Wajah</label>
                      <div class="col-sm-9">
                        <input type="text" name="bentuk_wajah" class="form-control" placeholder="Masukkan Bentuk Wajah" required="">
                      </div>
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th ><center>Bentuk Wajah</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_agama	=	mysql_query('select * from bentuk_wajah order by id desc');
				while($data	=	mysql_fetch_array($data_agama)){
			?>
              <tr>
                <td> <center><?php echo $no; ?></center></td>
                <td><?php echo $data['bentuk_wajah']; ?></td>
                <td> <center>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/bntkWajah.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="agama" class="col-sm-2 control-label">Bentuk Wajah</label>

                                <div class="col-sm-10">
                                  <input type="text" name="bentuk_wajah" class="form-control" placeholder="Masukkan Bentuk Wajah" value="<?php echo $data['bentuk_wajah']; ?>">
                                </div>
                                <br><br>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/bntkWajah.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
