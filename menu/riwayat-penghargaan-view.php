...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Riwayat Penghargaan <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" action="../crud/rwtPenghargaanView.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-lg-6">
                      ...
                      <label for="satuan" class="col-sm-5 control-label">Nama Penghargaan</label>
                      <div class="col-sm-7">
                        <select name="nama_penghargaan" id="nama_penghargaan" class="form-control mb10">
                          <option value="">Pilih Penghargaan</option>
                          <?php
                            $q=mysql_query("select * from master_penghargaan");
                      ...
                      <label for="satuan" class="col-sm-5 control-label">Nomor SK</label>
                      <div class="col-sm-7">
                        <input  type="text" class="form-control" name="nosk" placeholder="Masukkan Nomor SK"><br>
                      </div>

                     <label for="satuan" class="col-sm-5 control-label">Tanggal SK <i class="fa fa-calendar"> </i></label>
                 <div class="col-sm-7">
                <input type="text" class="form-control" name="tanggal_sk" id="tanggal_lahir" placeholder="Masukkan Tgl. SK"><br>
                 </div>
          ...
          <table id="" class="table table-bordered table-striped">
              <thead>
                <tr style="font-size:11px; ">
                  ...
                  <th ><center>Nama Penghargaan</center></th>
              ...
              //  $getid2=$_REQUEST['id'];
  				$no	=	1;
  				$data_pegawai	=	mysql_query("select * from rwt_penghargaan where id_peg='$getid' order by id desc");
  				while($data	=	mysql_fetch_array($data_pegawai)){
            $ph=$data['nama_penghargaan'];
            $ph2=mysql_query("select penghargaan from master_penghargaan where id='$ph'");
            $ph3=mysql_fetch_array($ph2);
  			?>
                <tr>
                  <td> <center><?php echo $no ?></center></td>
                  <td> <center><?php echo $ph3[0] ?></center></td>
                  <td> <center><?php echo $data['nosk'] ?></center></td>
                  <td> <center><?php echo date("d M Y", strtotime($data['tanggal_sk'])) ?></center></td>
                  <td width="100"> <center>
                    <a href="<?php 
                    echo $data['doc'];
                    ?>" target="_blank">doc </a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <span>  <a href="../crud/rwtPenghargaanView.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Delete" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                              </center>
                  ...
                  <div class="modal fade" id="myModalEdit<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $data['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                          <h4 class="modal-title<?php echo $data['id']; ?>" id="myModalLabel">Edit Riwayat Penghargaan</h4>
                        </div>
                        <div class="modal-body">

                          <form role="form" action="../crud/rwtPenghargaanView.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <input  type="hidden" class="form-control" name="getid" placeholder="" value="<?php echo $getid; ?>"></input>
                     
                       <label for="satuan" class="col-sm-4 control-label">Nama Penghargaan</label>
                                <div class="col-sm-8">
                                <select name="nama_penghargaan" id="nama_penghargaan" class="form-control mb10">
                                <option value="">Pilih Penghargaan</option>
                          <?php
                            ...
                            while($q2=mysql_fetch_array($q)){
                          ?>
                          <option value="<?php echo $q2[0] ?>" <?php if($data['nama_penghargaan']==$q2[0]) echo selected ?>><?php echo $q2[2] ?></option>
                          <?php }
                          ?>
                        </select>
                      </div>

                      <label for="satuan" class="col-sm-4 control-label">Nomor SK</label>
                      <div class="col-sm-8">
                        <input  type="text" class="form-control" name="nosk" placeholder="Masukkan Nomor SK" value="<?php echo $data['nosk']; ?>"><br>
                      </div>

                      <label for="satuan" class="col-sm-4 control-label">Tanggal SK   <i class="fa fa-calendar"> </i></label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="tanggal_sk" id="tanggal_lahir<?php echo $data['id'] ?>" placeholder="Masukkan Tgl. SK" value="<?php echo $data['tanggal_sk']; ?>"><br>
                      </div>
