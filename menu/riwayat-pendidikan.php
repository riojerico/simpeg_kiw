          ...
          <table id="data" class="table table-bordered table-striped">
  			...
  			?>
                <tr>
                  ...
                  <td width="200"><center>
                   <a class="btn btn-info btn-md" href="riwayat-pendidikan-view.php?id=<?php echo $data['id']; ?>"><span class="fa fa-arrow-circle-right " aria-hidden="true"></span> Riwayat Pendidikan</a>
                  </center>
                  </td>
