...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data Unit Kerja <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Unit Kerja</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/unit_kerja_Simpan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <div class="col-lg-12">
                          <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="UNT" ><br>
                      <label for="satuan" class="col-sm-4 control-label">Unit Kerja</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="unit_kerja" placeholder="Masukkan Unit Kerja" required=""><br>
                    </div>
                      </div>
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th width="90px"><center>Kode Unit</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from unit_kerja order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/unit_kerja_Simpan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <div class="col-lg-12">
                                  <div class="col-lg-12">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" name="kode" placeholder="Masukkan Kode Unit " value="<?php echo $data['kode']; ?>"><br>
                                  </div>

                                  <label for="satuan" class="col-sm-4 control-label">Satuan Kerja</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="unit_kerja" placeholder="Masukkan Unit Kerja" value="<?php echo $data['unit_kerja']; ?>"><br>
                                </div>
                                  </div>
                                </div>
<br><br><br><br><br>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/unit_kerja_Simpan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
