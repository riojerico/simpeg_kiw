...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Riwayat Kepangkatan <i class="fa fa-angle-double-down "></i></h3>
          ...
          <table id="data" class="table table-bordered table-striped">
  			...
  			?>
                <tr>
                  ...
                  <td width="200"><center>
                   <a class="btn btn-info btn-md" href="riwayat-kepangkatan-view.php?id=<?php echo $data['id']; ?>"><span class="fa fa-arrow-circle-right " aria-hidden="true"></span> Riwayat Kepangkatan</a>
                  </center>
                  </td>
