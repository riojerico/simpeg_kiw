...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Riwayat Pelatihan <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" action="../crud/rwtPelatihanView.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-lg-6">
                      ...
                      <label for="satuan" class="col-lg-5 control-label">Nama Pelatihan</label>
                      <div class="col-lg-7">
                        <input  type="text" class="form-control" name="nama_pelatihan" placeholder="Masukkan Nama Pelatihan"><br>
                      </div>
                     ...
                     <label for="satuan" class="col-sm-5 control-label">Tanggal Sertifikat   <i class="fa fa-calendar"> </i></label>
                 <div class="col-sm-7">
                <input type="text" class="form-control" name="tanggal_sertifikat" id="tanggal_lahir" placeholder="Masukkan Tgl. Ijazah" value="<?php echo $data['tglijazah']; ?>"><br>
                 </div>
...
<br>
        ...
        <div class="box-body">
          <table id="" class="table table-bordered table-striped">
              ...
              //  $getid2=$_REQUEST['id'];
  				$no	=	1;
  				$data_pegawai	=	mysql_query("select * from rwt_pelatihan where id_peg='$getid' order by id desc");
  				while($data	=	mysql_fetch_array($data_pegawai)){
  			?>
                <tr>
                  <td> <center><?php echo $no ?></center></td>
                  <td> <center><?php echo $data['nama_pelatihan'] ?></center></td>
                  <td> <center><?php echo $data['lokasi'] ?></center></td>
                  <td> <center><?php echo date("d M Y", strtotime($data['tanggal_sertifikat'])) ?></center></td>
                  <td width="100"> <center>
                    <a href="<?php 
                    echo $data['doc'];
                    ?>" target="_blank">doc </a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <span>  <a href="../crud/rwtPelatihanView.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Delete" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                              </center>
                  ...
                  <div class="modal fade" id="myModalEdit<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $data['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                          <h4 class="modal-title<?php echo $data['id']; ?>" id="myModalLabel">Edit Riwayat Pelatihan</h4>
                        </div>
                        <div class="modal-body">

                          <form role="form" action="../crud/rwtPelatihanView.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                               <input  type="hidden" class="form-control" name="getid" placeholder="" value="<?php echo $getid; ?>"></input>
                                <label for="satuan" class="col-lg-4 control-label">Nama Pelatihan</label>
                                <div class="col-lg-7">
                                  <input  type="text" class="form-control" name="nama_pelatihan" placeholder="Masukkan Nama Pelatihan" value="<?php echo $data['nama_pelatihan']; ?>"><br>
                                </div>
                                ...
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="tanggal_sertifikat" id="tanggal_lahir<?php echo $data['id'] ?>" placeholder="Masukkan Tgl. Ijazah" value="<?php echo $data['tanggal_sertifikat']; ?>"><br>
                                </div>
