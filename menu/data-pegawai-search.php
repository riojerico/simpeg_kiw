...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Pencarian Data Pegawai <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        <div class="box-header">
         ...
         <a href="data-pegawai.php"> <button class="btn btn-info btn-md"> <i class="fa fa-mail-reply-all"></i>
             All Data
          </button></a>
      ...
      $nama       = $_POST['term'];
          ...
          $no = 1;
          $data_pegawai =  mysql_query("select * from view_datapegawai_update where nama='$nama' ");
               ...
               <tr>
                ...
                <td width="250">  
                  <div class="clearfix ulku2">
                    <div class="col-sm-2 control-label"><strong>Nama</div>
                    <div class="col-sm-10"form-co>
                      : &nbsp;&nbsp;<?php echo $data['gelar_depan']; ?> <?php  echo $data['nama']; ?> <?php echo $data['gelar_belakang']; ?></strong>
                    </div>
                  </div>
                  <div class="clearfix ulku2">
                  ...
                  <td width="220"><br>
                    ...
                    <br><a class="btn btn-primary btn-xs col-md-12" data-toggle="modal" href="data-pegawai-view.php?id=<?php echo $data['id']; ?>" target="_blank"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>Lihat Selengkapnya</a>
                  </td>
                <td width="150">
