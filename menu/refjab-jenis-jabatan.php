...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data Jabatan Fungsional <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Jenis Jabatan</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/jenis_jabatan_Simpan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <div class="col-lg-12">
                        <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="JAB" ><br>

                      <label for="jenis" class="col-sm-4 control-label">Jenis Jabatan</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="jenis_jabatan" placeholder="Masukkan Jenis Jabatan" required=""><br>
                    </div>
                      </div>
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th width="90px"><center>Kode Jabatan</center></th>
                <th ><center>Jenis Jabatan</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from jenis_jabatan order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/jenis_jabatan_Simpan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                  ...
                                  <label for="satuan" class="col-sm-4 control-label">Jenis Jabatan</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="jenis_jabatan" placeholder="Masukkan Jenis Jabatan" value="<?php echo $data['jenis_jabatan']; ?>"><br>
                                </div>
                                  </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/jenis_jabatan_Simpan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
