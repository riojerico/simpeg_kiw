...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Riwayat Hukuman <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" action="../crud/rwtHukumanView.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="col-lg-6">
                      ...
                      <label for="satuan" class="col-sm-5 control-label">Nama Hukuman</label>
                      <div class="col-sm-7">
                        <select name="nama_hukuman" id="nama_hukuman" class="form-control mb10">
                          <option value="">Pilih hukuman</option>
                          <?php
                            $q=mysql_query("select * from master_hukuman");
                      ...
                      <label for="satuan" class="col-sm-5 control-label">Tanggal Hukuman <i class="fa fa-calendar"></i></label>
                     <div class="col-sm-7">
                        <input type="text" class="form-control" name="tgl" id="tanggal_lahir" placeholder="Masukkan Tanggal Hukuman" re><br>
                     </div>
          ...
          <table id="" class="table table-bordered table-striped">
              <thead>
                <tr style="font-size:11px; ">
                  ...
                  <th ><center>Nama Hukuman</center></th>
                  <th ><center>Tanggal Hukuman</center></th>
              ...
              //  $getid2=$_REQUEST['id'];
  				$no	=	1;
  				$data_pegawai	=	mysql_query("select * from rwt_hukuman where id_peg='$getid' order by id desc");
  				while($data	=	mysql_fetch_array($data_pegawai)){

            $hukuman=$data['nama_hukuman'];
            $hukuman2=mysql_query("select hukuman from master_hukuman where id='$hukuman'");
            $hukuman3=mysql_fetch_array($hukuman2);
  			?>
                <tr>
                  <td> <center><?php echo $no ?></center></td>
                  <td> <center><?php echo $hukuman3[0] ?></center></td>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <span>  <a href="../crud/rwtHukumanView.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Delete" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                              </center>
                  ...
                  <div class="modal fade" id="myModalEdit<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $data['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                          <h4 class="modal-title<?php echo $data['id']; ?>" id="myModalLabel">Edit Riwayat Hukuman</h4>
                        </div>
                        <div class="modal-body">

                          <form role="form" action="../crud/rwtHukumanView.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <input  type="hidden" class="form-control" name="getid" placeholder="" value="<?php echo $getid; ?>"></input>
                                

                                <label for="satuan" class="col-sm-4 control-label">Nama Hukuman</label>
                                <div class="col-sm-8">
                                <select name="nama_hukuman" id="nama_hukuman" class="form-control mb10">
                                <option value="">Pilih Hukuman</option>
                          <?php
                            ...
                            while($q2=mysql_fetch_array($q)){
                          ?>
                          <option value="<?php echo $q2[0] ?>" <?php if($data['nama_hukuman']==$q2[0]) echo selected ?>><?php echo $q2[2] ?></option>
                          <?php }
                          ?>
                        </select>
                      </div>

                                <label for="satuan" class="col-lg-4 control-label">Tanggal Hukuman <i class="fa fa-calendar"></i></label>
                               <div class="col-lg-8">
                                 <input type="text" class="form-control" name="tgl" id="tanggal_lahir" placeholder="Masukkan Tanggal Hukuman" value="<?php echo $data['tanggal']; ?>"><br>
                               </div>
