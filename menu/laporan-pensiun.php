...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Laporan Pensiun Tahun <?php echo date(Y) ?><i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="col-lg-12">
            ...
            <table border="1" align="center" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th width="100" align="center"><strong><center>Nik</center></strong></th>
            ...
            <a href="cetak-pensiun.php" target="_blank"><button type="submit" value="submitJabatan" name="submitJabatan" class="btn btn-success" ><i class="fa fa-save"></i> Export Ke PDF</button></a>
            <a href="laporan-pensiun-excel.php" target="_blank"><button type="submit" value="submitJabatan" name="submitJabatan" class="btn btn-info" ><i class="fa fa-save"></i> Export Ke Excel</button></a>
          </div>
        </div>
        <!-- /.box-body -->
