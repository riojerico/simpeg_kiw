...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Data Keluarga Istri / Suami <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" action="../crud/rwtDKistrisuami.php?id=<?php echo $data_pegawai['id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                 ...
                 <div class="clearfix">
                   ...
                   <div class="col-sm-7">
                     <input type="text" class="form-control" name="tgl_nikah" id="tanggal_lahir2" placeholder="Masukkan Tgl. Menikah" value="<?php echo $data['tgl_nikah']; ?>"><br>
                   </div>
                 </div>
...
<br><br><br>
        ...
        <div class="box-body">
          <table id="data1" class="table table-bordered table-striped">
              ...
              //  $getid2=$_REQUEST['id'];
  				$no	=	1;
  				$data_pegawai	=	mysql_query("select * from dk_istrisuami where id_peg='$getid' order by id desc");
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <span>  <a href="../crud/rwtDKistrisuami.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Delete" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                              </center>
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form role="form" action="../crud/rwtDKistrisuami.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                    <div class="panel-body">
                    <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                     ...
                     <label for="satuan" class="col-sm-5 control-label">Tgl. Menikah  <i class="fa fa-calendar"> </i></label>
                     <div class="col-sm-7">
                       <input type="text" class="form-control" name="tgl_nikah" id="tanggal_lahir2_<?php echo $data['id']; ?>" placeholder="Masukkan Tgl. Menikah" value="<?php echo $data['tgl_nikah']; ?>"><br>
                     </div>
                     <!-- 8 -->
                   <label for="satuan" class="col-sm-5 control-label">Pekerjaan</label>
                   <div class="col-sm-7">
                   ...
                   <div class="col-sm-7">
                     <select  class="form-control" name="tunjangan" >
                       <option value="">Pilih Status</option>
                       <option value="Mendapat Tunjangan" <?php if($data['tunjangan']=="Mendapat Tunjangan") echo selected ?>>Mendapat Tunjangan</option>
                       <option value="Tidak Mendapat Tunjangan" <?php if($data['tunjangan']=="Tidak Mendapat Tunjangan") echo selected ?>>Tidak Mendapat Tunjangan</option>
                     </select>
                   </div>
