...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Teguran <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Teguran</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/master_teguran.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <div class="col-lg-12">
                        
                      <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="WRN" ><br>

                        <label for="pangkat" class="col-sm-3 control-label">Teguran</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="teguran" placeholder="Masukkan Teguran" required=""><br>
                      </div>
                      </div>
        ...
        <div class="box-body">
          <table id="data" class="table table-bordered table-striped">
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from master_teguran order by id desc');
				while($data	=	mysql_fetch_array($data_jd)){
			?>
              <tr>
                <td> <center><?php echo $no; ?></center></td>
                <td><center><?php echo $data['kode']; ?><center></td>
                <td><?php echo $data['teguran']; ?></td>
                <td> <center>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/master_teguran.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">

                                <div class="col-lg-12">
                                  <label for="gol" class="col-sm-3 control-label">Kode Teguran</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" placeholder="Masukkan Kode" value="<?php echo $data['kode']; ?>" required=""><br>
                                  </div>
                                  <label for="pangkat" class="col-sm-3 control-label">Teguran</label>
                                  <div class="col-sm-9">
                                  <input type="text" class="form-control" name="teguran" placeholder="Masukkan Teguran" value="<?php echo $data['teguran']; ?>" required=""><br>
                                </div>
                                </div>
<br><br><br><br><br>
                              </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/master_teguran.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
