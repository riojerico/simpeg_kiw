...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data agama <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Agama</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/agamaSimpan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th ><center>Nama Agama</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_agama	=	mysql_query('select * from agama order by id desc');
			...
			?>
              <tr>
                ...
                <td> <center>
                  <a class="btn btn-warning btn-md" data-toggle="modal" data-target="#myModalEdit<?php echo $data['id']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true">Edit</span></a>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/agamaSimpan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="agama" class="col-sm-2 control-label">Agama</label>

                                <div class="col-sm-10">
                                  <input type="text" name="agama" class="form-control" placeholder="Masukkan Agama" value="<?php echo $data['agama']; ?>">
                                </div>
                                <br><br>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/agamaSimpan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
