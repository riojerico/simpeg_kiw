...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Penghargaan <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Penghargaan</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/master_penghargaan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <div class="col-lg-12">
                        
                      <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="RWD" ><br>

                        <label for="pangkat" class="col-sm-3 control-label">Penghargaan</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="penghargaan" placeholder="Masukkan Penghargaan" required=""><br>
                      </div>
                      </div>
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th width="90px"><center>Kode</center></th>
                <th ><center>Penghargaan</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from master_penghargaan order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/master_penghargaan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">

                                <div class="col-lg-12">
                                  <label for="gol" class="col-sm-3 control-label">Kode</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" placeholder="Masukkan Kode Penghargaan" value="<?php echo $data['kode']; ?>" required=""><br>
                                  </div>
                                  <label for="pangkat" class="col-sm-3 control-label">Penghargaan</label>
                                  <div class="col-sm-9">
                                  <input type="text" class="form-control" name="penghargaan" placeholder="Masukkan Penghargaan" value="<?php echo $data['penghargaan']; ?>" required=""><br>
                                </div>
                                </div>
<br><br><br><br><br>
                              </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/master_penghargaan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
