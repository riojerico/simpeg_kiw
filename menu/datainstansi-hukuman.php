...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Hukuman <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Hukuman</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/master_hukuman.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">

                      <div class="col-lg-12">
                        
                      <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="PUN" ><br>

                        <label for="pangkat" class="col-sm-3 control-label">Hukuman</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="hukuman" placeholder="Masukkan Hukuman" required=""><br>
                      </div>
                      </div>
        ...
        <div class="box-body">
          <table id="data" class="table table-bordered table-striped">
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from master_hukuman order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/master_hukuman.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">

                                <div class="col-lg-12">
                                  <label for="gol" class="col-sm-3 control-label">Kode Hukuman</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" placeholder="Masukkan Kode" value="<?php echo $data['kode']; ?>" required=""><br>
                                  </div>
                                  <label for="pangkat" class="col-sm-3 control-label">Hukuman</label>
                                  <div class="col-sm-9">
                                  <input type="text" class="form-control" name="hukuman" placeholder="Masukkan Hukuman" value="<?php echo $data['hukuman']; ?>" required=""><br>
                                </div>
                                </div>
<br><br><br><br><br>
                              </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/master_hukuman.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
