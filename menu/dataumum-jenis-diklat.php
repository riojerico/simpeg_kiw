...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data Jenis Diklat <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Jenis Diklat</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/jenis_diklat_Simpan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="kode" class="form-control" placeholder="Masukkan Kode" required=""><br>
                        </div>
                        <label for="jenis" class="col-sm-3 control-label">Jenis Diklat</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="jenis_diklat" placeholder="Masukkan Jenis Diklat" required=""><br>
                      </div>
                      </div>
        ...
        <div class="box-body">
          <table id="data" class="table table-bordered table-striped">
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from jenis_diklat order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/jenis_diklat_Simpan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <div class="col-lg-12">
                                  <label for="kode" class="col-sm-3 control-label">Kode</label>
                                  ...
                                  <label for="jenis" class="col-sm-3 control-label">Jenis Diklat</label>
                                  <div class="col-sm-9">
                                  <input type="text" class="form-control" name="jenis_diklat" placeholder="Masukkan Jenis Diklat" value="<?php echo $data['jenis_diklat']; ?>"><br>
                                </div>
                                </div>
<br><br><br><br><br>
                              </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/jenis_diklat_Simpan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
