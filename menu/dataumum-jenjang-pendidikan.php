...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Referensi Data Jenjang Pendidikan <i class="fa fa-angle-double-down "></i></h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Data Jenjang Pendidikan</h4>
              </div>
              <div class="modal-body">

                <form class="form-horizontal" action="../crud/pendidikanSimpan.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                       <!--  <label for="kode" class="col-sm-3 control-label">Kode</label>
                        <div class="col-sm-9"> -->
                          <input type="hidden" name="kode" class="form-control" placeholder="Masukkan Kode" required="" value="EDU" ><br>
                       <!--  </div> -->
                        <label for="pendidikan" class="col-sm-3 control-label">Pendidikan</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="pendidikan" placeholder="Masukkan Pendidikan" required=""><br>
                      </div>
                      </div>
          ...
          <table id="data" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th width="10px"><center>Kode</center></th>
            ...
            <?php
				...
				$no	=	1;
				$data_jd	=	mysql_query('select * from jenjang_pendidikan order by id desc');
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form class="form-horizontal" action="../crud/pendidikanSimpan.php?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              <div class="form-group">
                                <div class="col-lg-12">
                                  <label for="kode" class="col-sm-3 control-label">Kode</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="kode" class="form-control" placeholder="Masukkan Kode" value="<?php echo $data['kode']; ?>"><br>
                                  </div>
                                  <label for="jenis" class="col-sm-3 control-label">Pendidikan</label>
                                  <div class="col-sm-9">
                                  <input type="text" class="form-control" name="pendidikan" placeholder="Masukkan Pendidikan" value="<?php echo $data['pendidikan']; ?>"><br>
                                </div>
                                </div>
<br><br><br><br><br>
                              </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <span>  <a href="../crud/pendidikanSimpan.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Simpan" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                          </center>
