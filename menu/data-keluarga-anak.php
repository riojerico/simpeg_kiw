...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="">
        <h3>Data Keluarga Anak <i class="fa fa-angle-double-down "></i></h3>
      ...
      <div class="box">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" action="../crud/rwtDKanak.php?id=<?php echo $data_pegawai['id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                 ...
                 <label for="satuan" class="col-sm-5 control-label">Keterangan Status Anak</label>
                 <div class="col-sm-7">
                   <input  type="text" class="form-control" name="ket" placeholder="Masukkan Keterangan" value="<?php echo $data['ket']; ?>"><br>
                 </div>
...
<br><br><br><br><br>
        ...
        <div class="box-body">
          <table id="data1" class="table table-bordered table-striped">
              ...
              //  $getid2=$_REQUEST['id'];
  				$no	=	1;
  				$data_pegawai	=	mysql_query("select * from dk_anak where id_peg='$getid' order by id desc");
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <span>  <a href="../crud/rwtDKanak.php?id=<?php echo $data['id']; ?>"><button type="submit" value="Delete" name="Delete" class="btn btn-danger">Hapus</button></a></span>
                              </center>
          ...
          <div class="modal fade" id="myModalEdit<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $data['id']; ?>" aria-hidden="true">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title<?php echo $data['id']; ?>" id="myModalLabel">Edit Data Keluarga Anak</h4>
                </div>
                <div class="modal-body">

                  <form role="form" action="../crud/rwtDKanak.php?id=<?php echo $data['id_peg']; ?>" method="post" enctype="multipart/form-data">
                    <div class="panel-body">
                    <div class="col-lg-6">
                        <?php $getid = $_REQUEST['id']; ?>
                          <input  type="hidden" class="form-control" name="getid" placeholder="Masukkan Nama Tempat" value="<?php echo $getid; ?>"></input>
                      ...
                      <div class="col-lg-7">
                        <select name="status" class="form-control"> 
                          ...
                          <option value="Kandung" <?php if($data['status']=="Kandung") echo selected ?> >Kandung</option>
                          <option value="Angkat" <?php if($data['status']=="Angkat") echo selected ?>>Angkat</option>
                        </select><br>
                      </div>
                      <!-- 2 -->
                      <label for="satuan" class="col-sm-5 control-label">Nama</label>
